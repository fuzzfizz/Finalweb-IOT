...
var client_1 = require("@prisma/client"); // เชื่อมต่อ Prisma กับฐานข้อมูล PostgreSQL
var prisma = new client_1.PrismaClient(); // สร้าง instance ของ PrismaClient
    ...
    io.on("connection", function (socket) {
        ...
        var interval = setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.aTH034.findFirst({
                            orderBy: { date_time: "desc" },
                        })];
                    case 1:
                        latest = _a.sent();
                        return [4 /*yield*/, prisma.aTH034.findMany({})];
                    case 2:
                        result = _a.sent();
